...
drop table results;
create table results( Symbol char(6), Price numeric, Type char(4), Strike numeric, ExpDate char(12), DTE int, Bid numeric,  Midpoint numeric, Ask numeric, Last numeric, Volume int, OpenInterest int, Ratio numeric, IV char(10), Time char(12));
insert into results
